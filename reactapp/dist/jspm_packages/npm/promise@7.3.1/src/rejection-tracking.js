...
function enable(options) {
  ...
  Promise._onHandle = function (promise) {
    if (promise._state === 2 && rejections[promise._rejectionId]) {
  ...
  Promise._onReject = function (promise, err) {
    if (promise._deferredState === 0) {
      ...
      rejections[promise._rejectionId] = {
        displayId: null,
        error: err,
        timeout: setTimeout(onUnhandled.bind(null, promise._rejectionId), matchWhitelist(err, DEFAULT_WHITELIST) ? 100 : 2000),
        logged: false
      };
    }
  };
...
//# sourceMappingURL=rejection-tracking.js.map