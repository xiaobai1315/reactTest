...
var getter = Object.create(null, { a: { get: function get() {
      return 'aaa';
    } } });
var setter = Object.create(null, { b: { set: function set() {} } });
...
assert(util.inspect(subject, { colors: false }).indexOf('\x1B[32m') === -1);
assert(util.inspect(subject, { colors: true }).indexOf('\x1B[32m') !== -1);
