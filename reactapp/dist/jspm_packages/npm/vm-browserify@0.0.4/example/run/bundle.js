...
/* */
(function (process) {
  var require = function require(file, cwd) {
    ...
    return function (x, cwd) {
      ...
      function loadAsDirectorySync(x) {
        ...
        if (require.modules[pkgfile]) {
          ...
          if ((typeof b === 'undefined' ? 'undefined' : _typeof(b)) === 'object' && b.main) {
  ...
  if (!process.binding) process.binding = function (name) {
    if (name === 'evals') return require('vm');else throw new Error('No such module');
  };
