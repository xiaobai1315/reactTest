  ...
  (function (f) {
    ...
    return function e(t, n, r) {
      ...
      3: [function (_dereq_, module, exports) {
        ...
        var LinkedStateMixin = { linkState: function linkState(key) {
      ...
      5: [function (_dereq_, module, exports) {
        ...
        if ("development" !== 'production') {
          ...
          if (canDefineProperty) {
            Object.defineProperty(React, 'PropTypes', { get: function get() {
                lowPriorityWarning(didWarnPropTypesDeprecated, 'Accessing PropTypes via the main React package is deprecated,' + ' and will be removed in  React v16.0.' + ' Use the latest available v15.* prop-types package from npm instead.' + ' For info on usage, compatibility, migration and more, see ' + 'https://fb.me/prop-types-docs');
                didWarnPropTypesDeprecated = true;
                return ReactPropTypes;
              } });
            Object.defineProperty(React, 'createClass', { get: function get() {
      ...
      7: [function (_dereq_, module, exports) {
        ...
        if ("development" !== 'production') {
          ...
          var defineDeprecationWarning = function defineDeprecationWarning(methodName, info) {
            if (canDefineProperty) {
              Object.defineProperty(ReactComponent.prototype, methodName, { get: function get() {
      ...
      12: [function (_dereq_, module, exports) {
        ...
        var ReactComponentWithPureRenderMixin = { shouldComponentUpdate: function shouldComponentUpdate(nextProps, nextState) {
      ...
      18: [function (_dereq_, module, exports) {
        ...
        var ReactFragment = { create: function create(object) {
      ...
      30: [function (_dereq_, module, exports) {
        ...
        var ReactWithAddonsUMDEntry = _assign(ReactWithAddons, {
          ...
          __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: { ReactCurrentOwner: _dereq_(13) }
        });
        if ("development" !== 'production') {
      ...
      43: [function (_dereq_, module, exports) {
        ...
        function factory(ReactComponent, isValidElement, ReactNoopUpdateQueue) {
          ...
          var IsMountedPreMixin = { componentDidMount: function componentDidMount() {
              this.__isMounted = true;
            } };
          var IsMountedPostMixin = { componentWillUnmount: function componentWillUnmount() {
