...
assert.throws(function () {
  return Buffer.from(buf3).swap16();
}, re16);
assert.throws(function () {
  return Buffer.alloc(1025).swap16();
}, re16);
assert.throws(function () {
  return Buffer.from(buf3).swap32();
}, re32);
assert.throws(function () {
  return buf3.slice(1, 3).swap32();
}, re32);
assert.throws(function () {
  return Buffer.alloc(1025).swap32();
}, re32);
assert.throws(function () {
  return buf3.slice(1, 3).swap64();
}, re64);
assert.throws(function () {
  return Buffer.alloc(1025).swap64();
}, re64);
//# sourceMappingURL=test-buffer-swap.js.map