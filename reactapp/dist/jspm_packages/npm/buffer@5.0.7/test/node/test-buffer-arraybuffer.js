...
b.writeDoubleBE(11.11, 0, true);
{
  ...
  assert.equal(ab[1], 9);
  assert.throws(function () {
    return Buffer.from(ab.buffer, 6);
  }, function (err) {
  ...
  assert.throws(function () {
    return Buffer.from(ab.buffer, 3, 6);
  }, function (err) {
    assert(err instanceof RangeError);
...
//# sourceMappingURL=test-buffer-arraybuffer.js.map